...
function PlayState:enter(params)
    ...
    local inputBall = params.ball
    self.level = params.level

    self.recoverPoints = 5000

    -- give ball random starting velocity
    inputBall.dx = math.random(-200, 200)
    inputBall.dy = math.random(-50, -60)
    self.balls = {}
    table.insert(self.balls, inputBall)
    self.brickHit = 0

    self.powerup = Powerup(VIRTUAL_WIDTH / 2, 0, math.random(8))
end
